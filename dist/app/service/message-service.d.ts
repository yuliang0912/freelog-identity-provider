...
export declare class MessageService implements IMessageService {
     ...
     */
    sendMessage(authCodeType: 'register' | 'resetPassword' | 'activateTransactionAccount' | 'updateTransactionAccountPwd', toAddress: string): Promise<void>;
    /**
     * 校验验证码是否正确
     * @param authCodeType
     * @param address
     * @param authCode
     */
    verify(authCodeType: 'register' | 'resetPassword' | 'activateTransactionAccount' | 'updateTransactionAccountPwd', address: string, authCode: number): Promise<boolean>;
}
